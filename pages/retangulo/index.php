                ...
                <form action="acao.php" method="post">
                    <div>                       
                        ...
                        <div>
                            ...
                            <input type="text" name="largura" id="largura"  value="<?php if($qeditando) echo $qeditando->getLargura(); ?>">
                        </div>
                        <div>
                            <label for="altura">Altura</label>
                            <input type="text" name="altura" id="altura"  value="<?php if($qeditando) echo $qeditando->getAltura(); ?>">
                        </div>
                        <div>
